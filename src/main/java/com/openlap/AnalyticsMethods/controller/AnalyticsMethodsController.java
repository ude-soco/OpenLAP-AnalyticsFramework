...
public class AnalyticsMethodsController {
    ...
    /**
     * HTTP endpoint handler method that allows to validate an OpenLAPPortConfig of a specific AnalyticsMethods.
     *
     * @param configurationMapping The OpenLAPPortConfig to be validated
     * @param id                   The ID of the AnalyticsMethods Metadata to be validated against the OpenLAPPortConfig.
    ...
    public @ResponseBody List<OpenLAPColumnConfigData> getInputPorts(@PathVariable String id) {
    ...
    public @ResponseBody List<OpenLAPColumnConfigData> getOutputPorts (@PathVariable String id) {
